...
CHAPTERS: List[Chapter] = [
    ...
    ("https://www.py4e.com/html3/04-functions.php", "py4e_04_functions", "Functions", "beginner"),
    ("https://www.py4e.com/html3/05-iterations.php", "py4e_05_iterations", "Iterations", "beginner"),
    ...
    ("https://www.py4e.com/html3/11-regex.php", "py4e_11_regex", "Regular Expressions", "intermediate"),
    ...
    ("https://www.py4e.com/html3/15-database.php", "py4e_15_database", "Python and Databases", "advanced"),
    ("https://www.py4e.com/html3/16-viz.php", "py4e_16_viz", "Data Visualization", "advanced"),
]
